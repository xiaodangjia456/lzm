...
<body>
	<br>
	<form class="layui-form" action="min/device" data-type="ajax" id="formId" method="post">
		<input type="hidden" id="siteId" name="siteId" value="${siteId }"> 
		<input type="hidden" id="deviceLng" name="deviceLng" value=""> 
		<input type="hidden" id="deviceLat" name="deviceLat" value="">
