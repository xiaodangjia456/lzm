...
<!-- body -->
<body>
<form class="layui-form" data-type="ajax" action="min/imgpicture/${item.id}" id="formId" method="post">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="siteAlias" id="siteAlias" value="${item.siteAlias}" lay-verify="required" autocomplete="off" placeholder="请输入站点别名"
				class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="imgDate" id="imgDate" value="${item.imgDate}" lay-verify="required" autocomplete="off" placeholder="请输入图片日期（年-月-日）"
				class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="imgName" id="imgName" value="${item.imgName}" lay-verify="required" autocomplete="off" placeholder="请输入图片名称"
				class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="imgPath" id="imgPath" value="${item.imgPath}" lay-verify="required" autocomplete="off" placeholder="请输入图片全路径"
				class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="createTime" id="createTime" value="${item.createTime}" lay-verify="required" autocomplete="off" placeholder="请输入数据创建时间"
				class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<input type="text" name="imgType" id="imgType" value="${item.imgType}" lay-verify="required" autocomplete="off" placeholder="请输入图片类型"
				class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
