...
<!-- search Start -->
<form class="layui-form  layui-form-pane" action="min/imgspore/get/pre" method="get" id="searchForm" name="searchForm">
	...
	<div class="layui-btn-group">
		...
		<button type="button" class="layui-btn layui-btn-sm layui-btn-normal" onclick="JavaScript:MinFormUtil.toAddPage('imgspore','');">
		...
		<tbody>
			<c:forEach items="${list}" var="item" varStatus="status">
				<tr>
					...
					<td nowrap="nowrap">
						<div class="layui-btn-group">
							<button type="button" class="layui-btn layui-btn-primary layui-btn-xs" onclick="MinFormUtil.showDetail('imgspore', ${item.id}, '');">查看</button>
							<button type="button" class="layui-btn layui-btn-normal layui-btn-xs" onclick="MinFormUtil.toUpdatePage('imgspore', ${item.id}, '');">修改</button>
							<button type="button" class="layui-btn layui-btn-danger layui-btn-xs" onclick="MinFormUtil.delForm('imgspore',${item.id};">删除</button>
						</div>
					</td>
				</tr>
